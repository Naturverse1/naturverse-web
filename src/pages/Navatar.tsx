        ...
        <div className="row wrap gap">
          ...
          <div className="stack">
            ...
            <div className="row gap">
              <button type="button" className="btn" onClick={regen}>Regenerate</button>
              <button type="button" className="btn outline" onClick={save}>Save Navatar</button>
            </div>
          </div>
        </div>
      </div>
        ...
        {list().map(x => (
          <div key={x.id} className="hub-card">
            ...
            <button
              type="button"
              className="btn tiny"
              onClick={() => { setCurrent(x); setNav(x); setName(x.name); setPower(x.power); setBackstory(x.backstory); setPhoto(x.photo); }}>
              Set Active
            </button>
          </div>
        ))}
