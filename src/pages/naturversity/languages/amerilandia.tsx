  ...
  return (
    <main>
      <nav className="breadcrumbs">
        <a href="/">Home</a> / <a href="/naturversity">Naturversity</a> / <a href="/naturversity/languages">Languages</a> / Amerilandia (English)
      </nav>

      <h1>Amerilandia (English) — English</h1>
      <p>Learn greetings, alphabet basics, and common phrases for Amerilandia.</p>

      <section className="lang-page">
        <div>
          <img
            className="lang-hero"
            src="/Languages/Owllanguagemain.png"
            alt="English welcome illustration"
          />
          <img
            className="lang-secondary"
            src="/Languages/Turianlanguageenglish.png"
