  ...
  return (
    <main>
      <nav className="breadcrumbs">
        <a href="/">Home</a> / <a href="/naturversity">Naturversity</a> / <a href="/naturversity/languages">Languages</a> / Australandia (English)
      </nav>

      <h1>Australandia (English) — English</h1>
      <p>Learn greetings, alphabet basics, and common phrases for Australandia.</p>

      <section className="lang-page">
        <div>
          <img
            className="lang-hero"
            src="/Languages/Koalalanguagemain.png"
            alt="English welcome illustration"
          />
          <img
            className="lang-secondary"
            src="/Languages/Birdlanguageaustralandia.png"
