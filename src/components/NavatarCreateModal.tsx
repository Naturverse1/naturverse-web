      ...
      <div className="w-full max-w-xl rounded-2xl bg-white p-6 shadow-xl">
        ...
        <div className="mb-4 grid grid-cols-3 gap-2">
          <button
            ...
            className={`rounded-full px-3 py-2 text-sm ${tab === 'upload' ? 'bg-blue-600 text-white' : 'bg-gray-100'}`}
          >
            Upload
          </button>
          <button
            onClick={() => setTab('ai')}
            className={`rounded-full px-3 py-2 text-sm ${tab === 'ai' ? 'bg-blue-600 text-white' : 'bg-gray-100'}`}
          >
            Describe & Generate
          </button>
          <button
            onClick={() => setTab('canon')}
            className={`rounded-full px-3 py-2 text-sm ${tab === 'canon' ? 'bg-blue-600 text-white' : 'bg-gray-100'}`}
          >
            Pick Canon
          </button>
        </div>
