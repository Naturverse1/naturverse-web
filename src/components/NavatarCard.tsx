  ...
  return (
    <div className="navatar-card">
      <div className="navatar-card__left" style={{ borderColor: n.color }}>
        {n.photo ? <img src={n.photo} alt={n.name} /> : <div className="big-emoji" style={{ color: n.color }}>{n.emoji}</div>}
      </div>
      <div className="navatar-card__right">
        ...
        <button type="button" className="btn tiny" onClick={download}>Download PNG</button>
      </div>
