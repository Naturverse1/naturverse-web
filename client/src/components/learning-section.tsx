export function LearningSection() {
  ...
  return (
    <section id="learning" className="min-h-screen bg-gradient-to-br from-blue-900 via-indigo-800 to-sky-900 py-20 relative overflow-hidden">
      {/* Animated background */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-1/4 w-2 h-2 bg-blue-400 rounded-full animate-ping"></div>
        <div className="absolute top-40 right-1/3 w-3 h-3 bg-sky-400 rounded-full animate-ping" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-60 left-1/3 w-2 h-2 bg-blue-400 rounded-full animate-ping" style={{ animationDelay: '2s' }}></div>
        <div className="absolute bottom-40 right-1/4 w-3 h-3 bg-indigo-400 rounded-full animate-ping" style={{ animationDelay: '3s' }}></div>
      </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8" data-testid="learning-grid">
          {learningAreas.map((area, index) => (
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 text-sky-300 animate-pulse text-sm" style={{ animationDelay: '1.5s' }}>🌟</div>
            </div>
          ))}
        </div>
