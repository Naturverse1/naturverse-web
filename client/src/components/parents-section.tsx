...
export function ParentsSection() {
  ...
  return (
    <section
      id="parents"
      className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-20 relative overflow-hidden"
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-32 right-20 w-48 h-48 bg-gradient-to-br from-sky-100 to-cyan-100 rounded-full opacity-40 animate-float"
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in" data-testid="parents-header">
          ...
          <h2
            className="font-fredoka text-5xl md:text-7xl bg-gradient-to-r from-blue-700 via-sky-600 to-cyan-600 bg-clip-text text-transparent mb-8"
            data-testid="text-parents-title"
          >
            👪 For Parents
          </h2>
          <div className="max-w-4xl mx-auto">
            <p
              ...
              data-testid="text-parents-main"
            >
              100% kid-safe. COPPA compliant. Optional crypto wallet with parental control.
            </p>
            <p
              className="text-xl text-gray-600 leading-relaxed"
              data-testid="text-parents-description"
            >
              We've created a secure, educational environment where your children can explore,
              learn, and grow while you maintain complete peace of mind.
            </p>
          </div>
        </div>
          ...
          {safetyFeatures.map((feature, index) => (
            ...
            >
              <div className="text-center">
                ...
                <h3
                  className="font-fredoka text-2xl text-gray-800 mb-4"
                  data-testid={`title-${feature.title.toLowerCase().replace(/\s+/g, '-')}`}
                >
                  {feature.title}
                </h3>
                <p
                  className="text-gray-600 leading-relaxed text-lg"
                  data-testid={`description-${feature.title.toLowerCase().replace(/\s+/g, '-')}`}
                >
                  {feature.description}
                </p>
              </div>
        ...
        {/* Trust indicators */}
        <div
          className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-3xl p-12 text-white text-center animate-fade-in-delay"
        ...
        >
          ...
          <p
            ...
            data-testid="text-trust-description"
          >
            Join thousands of parents who trust The Naturverse™ to provide safe, educational, and
            magical learning experiences for their children.
          </p>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 max-w-4xl mx-auto border border-white/20">
            ...
            <p className="text-lg italic mb-4 opacity-90">
              "Finally, a platform where my kids can learn about technology and nature safely. The
              parental controls give me complete peace of mind!"
            </p>
