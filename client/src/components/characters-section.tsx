...
export function CharactersSection() {
  ...
  return (
    <section
      id="characters"
      className="min-h-screen bg-gradient-to-br from-blue-50 via-sky-50 to-cyan-50 py-20 relative overflow-hidden"
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-40 right-20 w-24 h-24 bg-gradient-to-br from-cyan-200 to-blue-300 rounded-full opacity-40 animate-float"
          style={{ animationDelay: '2s' }}
        ></div>
        <div
          className="absolute bottom-40 left-20 w-40 h-40 bg-gradient-to-br from-indigo-200 to-blue-200 rounded-full opacity-30 animate-float"
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in" data-testid="characters-header">
          <h2
            className="font-fredoka text-5xl md:text-7xl bg-gradient-to-r from-blue-700 via-sky-600 to-cyan-600 bg-clip-text text-transparent mb-6"
            data-testid="text-characters-title"
          >
            🌟 Meet Your Magical Guides
          </h2>
          <p
            className="text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium mb-4"
            data-testid="text-characters-description"
          >
            Your friendly companions will guide you through every magical adventure in The
            Naturverse™!
          </p>
          ...
          {characters.map((character, index) => (
            ...
            >
              ...
              <div
                ...
                data-testid={`image-${character.id}`}
              >
              ...
              <div className="text-center">
                <h3
                  className="font-fredoka text-2xl bg-gradient-to-r from-blue-700 to-sky-600 bg-clip-text text-transparent mb-2"
                ...
                <p
                  ...
                  data-testid={`description-${character.id}`}
                >
              ...
              <div
                className="absolute bottom-4 left-4 text-sky-400 animate-pulse"
