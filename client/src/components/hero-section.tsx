...
export function HeroSection({ onStartExploring }: HeroSectionProps) {
  return (
    <section id="hero" className="min-h-screen relative bg-gradient-to-br from-blue-900 via-indigo-900 to-sky-900 flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-20 right-20 w-80 h-80 bg-gradient-to-r from-cyan-400/20 to-blue-400/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-indigo-400/10 to-blue-400/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '4s' }}></div>
      </div>
      ...
      <div className="relative z-10 px-6 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 animate-fade-in" data-testid="logo-container">
          <div className="inline-block relative">
            ...
            <div className="absolute top-8 right-8 text-sky-300 text-xl animate-ping" style={{ animationDelay: '1s' }}>🌟</div>
            <div className="absolute bottom-8 left-8 text-cyan-300 text-lg animate-ping" style={{ animationDelay: '2s' }}>💫</div>
          </div>
        </div>
