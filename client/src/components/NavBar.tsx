...
const NavBar: React.FC = () => {
  ...
  const navItems = [
    { href: "/", label: "Home", icon: "🏠", character: TurianCharacter, color: "from-green-400 to-green-600" },
    { href: "/map", label: "Map", icon: "🗺️", character: CoconutCruze, color: "from-blue-400 to-blue-600" },
    { href: "/quests", label: "Quests", icon: "⚡", character: FrankieFrogs, color: "from-purple-400 to-purple-600" },
    { href: "/storybook", label: "Stories", icon: "📚", character: BluButterfly, color: "from-pink-400 to-pink-600" },
    { href: "/navatar", label: "Navatar", icon: "👤", character: JaySing, color: "from-yellow-400 to-orange-500" },
    { href: "/quiz", label: "Quiz", icon: "🧠", character: MangoMike, color: "from-red-400 to-red-600" },
  ];
  ...
  return (
    <nav className="sticky top-0 z-50 nav-magical shadow-2xl">
          ...
          >
            <div className="flex items-center space-x-3">
              <div className="relative">
                ...
                />
                <div className="absolute -top-1 -right-1 text-yellow-300 text-xl animate-sparkle-dance">✨</div>
              </div>
              <div>
          ...
          <div className="hidden lg:flex items-center space-x-2">
            {navItems.map((item, index) => (
              ...
              >
                ...
                {/* Hover Background */}
                <div className={`absolute inset-0 bg-gradient-to-r ${item.color} opacity-0 group-hover:opacity-30 rounded-2xl transition-opacity duration-300`} />
              </Link>
            ))}
          </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link to="/profile" className="flex items-center space-x-2 hover:scale-105 transition-all duration-300">
                ...
                <div className="hidden md:block">
                  <div className="text-white font-bold text-sm font-playful">
                    Welcome back!
                  </div>
      ...
      {/* Floating Sparkles */}
      <div className="floating-sparkles" style={{ top: '20px', left: '15%' }}>✨</div>
      <div className="floating-sparkles" style={{ top: '40px', right: '25%', animationDelay: '1s' }}>🌟</div>
      <div className="floating-sparkles" style={{ bottom: '10px', left: '30%', animationDelay: '2s' }}>⭐</div>
      <div className="floating-sparkles" style={{ top: '15px', right: '10%', animationDelay: '1.5s' }}>✨</div>
    </nav>
  );
};
