  ...
  const zones: Zone[] = [
    {
      ...
      description:
        "The magical durian kingdom where Turian teaches about tropical fruits and nature's wisdom!",
      unlocked: true,
    ...
    },
    {
      ...
      description:
        'Dance with Blue Butterfly through colorful flower fields and discover pollination magic!',
      unlocked: true,
    ...
    },
    {
      ...
      description:
        'Splash with Frankie Frogs and learn about amphibian life cycles and wetland ecosystems!',
      unlocked: true,
    ...
    },
    {
      ...
      description:
        "Make beautiful music with Jay-Sing and learn about sound, rhythm, and nature's orchestra!",
      unlocked: false,
      character: 'Jay-Sing',
    ...
    },
    {
      ...
      description:
        'Climb high peaks with Nikki MT and explore mountain ecosystems and weather patterns!',
      unlocked: false,
      character: 'Nikki MT',
    ...
    },
    {
      ...
      description:
        'Explore tropical paradise with Pineapple Pa-Pa and learn about sustainable farming!',
      unlocked: false,
      ...
      <div className="relative z-10 min-h-screen py-8 px-6">
        ...
        <div className="text-center mb-8">
          ...
          <div className="max-w-md mx-auto bg-white/90 backdrop-blur-sm p-4 rounded-2xl border-4 border-green-300/60 shadow-xl">
            <p
              className="text-lg font-bold text-green-700 mb-2"
              style={{ fontFamily: 'Fredoka, sans-serif' }}
            >
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
          <div
            className="absolute top-1/4 left-8 animate-float-bounce opacity-60"
            style={{ animationDelay: '0s' }}
          >
            <div className="w-12 h-12 p-1 bg-white/60 rounded-2xl border-2 border-yellow-400 shadow-lg">
              <img src={Snakers} alt="Snakers" className="w-full h-full object-cover rounded-xl" />
            </div>
          </div>

          <div
            className="absolute top-1/3 right-12 animate-gentle-pulse opacity-50"
            style={{ animationDelay: '2s' }}
          >
            <div className="w-10 h-10 p-1 bg-white/60 rounded-full border-2 border-pink-400 shadow-lg">
              <img src={Teeyor} alt="Teeyor" className="w-full h-full object-cover rounded-full" />
            </div>
          </div>

          <div
            className="absolute bottom-1/4 left-1/4 animate-float-bounce opacity-40"
