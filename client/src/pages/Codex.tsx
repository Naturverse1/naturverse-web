...
export default function Codex() {
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      case "navatar": return "bg-magic text-white";
      case "story": return "bg-nature text-white";
      case "quiz": return "bg-turquoise text-white";
      case "music": return "bg-sunny text-black";
      case "achievement": return "bg-coral text-white";
  ...
  const filteredContent = activeTab === "all" 
    ? savedContent 
    : savedContent.filter(item => item.type === activeTab);
          ...
          <CardHeader>
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <TabsList className="grid w-full grid-cols-6">
                <TabsTrigger value="all" data-testid="tab-all">All ({contentByType.all})</TabsTrigger>
                <TabsTrigger value="navatar" data-testid="tab-navatar">🎨 ({contentByType.navatar})</TabsTrigger>
                <TabsTrigger value="story" data-testid="tab-story">📚 ({contentByType.story})</TabsTrigger>
                <TabsTrigger value="quiz" data-testid="tab-quiz">🧠 ({contentByType.quiz})</TabsTrigger>
                <TabsTrigger value="music" data-testid="tab-music">🎵 ({contentByType.music})</TabsTrigger>
                <TabsTrigger value="achievement" data-testid="tab-achievement">🏆 ({contentByType.achievement})</TabsTrigger>
              </TabsList>
            </Tabs>
          </CardHeader>
          <CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredContent.map((item) => (
                  ...
                  >
                    ...
                    <CardContent>
                      <p className="text-forest/80 text-sm mb-3">
                        {item.description}
                      </p>
