...
export default function Market() {
  ...
  const getRarityColor = (rarity: string) => {
    switch (rarity) {
      ...
      case "rare": return "bg-turquoise text-white";
      case "epic": return "bg-magic text-white";
      case "legendary": return "bg-sunny text-black";
      ...
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="text-center mb-8">
          ...
          <p className="text-white/90 text-lg">
            Discover magical items to enhance your adventure!
          </p>
          ...
          {filteredItems.map((item) => (
            ...
            >
              <CardHeader className="text-center">
                <div className={`text-5xl mb-3 ${item.isLocked ? 'opacity-50' : 'animate-bounce-gentle'}`}>
                ...
                <CardTitle className={`text-lg font-fredoka ${item.isLocked ? 'text-gray-500' : 'text-forest'}`}>
                  {item.name}
                </CardTitle>
              </CardHeader>
              <CardContent>
        ...
        {filteredItems.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-white/70">
              Check back later for new magical items!
            </p>
          </div>
        )}
      </div>
