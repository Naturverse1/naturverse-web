...
export default function AI() {
  ...
  useEffect(() => {
    ...
    const welcomeMessage: ChatMessage = {
      id: "welcome",
      type: "ai",
      content: "🌟 Greetings, young explorer! I'm Turian, your AI assistant in The Naturverse. I'm here to help you learn about nature, answer your questions, and guide you on your magical journey. What would you like to discover today?",
          ...
          <CardContent>
                ...
                <div className="mb-4 flex justify-start">
                  <div className="bg-white border border-nature/20 text-forest px-4 py-2 rounded-lg">
                    <div className="flex space-x-1">
                      ...
                      <div className="w-2 h-2 bg-nature rounded-full animate-bounce" style={{animationDelay: '0.1s'}}></div>
                      <div className="w-2 h-2 bg-nature rounded-full animate-bounce" style={{animationDelay: '0.2s'}}></div>
                    </div>
                  </div>
                </div>
              )}
            ...
            <div className="mt-4 text-center">
              <p className="text-xs text-forest/60">
                💡 Tip: Ask specific questions about nature topics, request learning recommendations, or get help with quizzes and modules!
              </p>
            </div>
          </CardContent>
        </Card>
