...
export default function Modules() {
  ...
  const getDifficultyColor = (difficulty: string) => {
    switch (difficulty) {
      case "beginner": return "bg-nature text-white";
      case "intermediate": return "bg-sunny text-black";
      case "advanced": return "bg-coral text-white";
          ...
          <Card className="backdrop-blur-sm bg-white/95 border-nature/20 shadow-xl mb-8">
            <CardContent className="pt-6">
              <div className="text-center">
                ...
                <Progress value={(completedModules / totalModules) * 100} className="w-full max-w-md mx-auto h-3" />
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="flex justify-center mb-8 space-x-4">
          {["all", "beginner", "intermediate", "advanced"].map((level) => (
            <Button
              ...
              className={filter === level ? "bg-nature text-white" : "border-white text-white hover:bg-white hover:text-forest"}
            ...
            >
              <CardHeader>
                <div className="flex justify-between items-start mb-2">
                  <CardTitle className="text-lg font-fredoka text-forest">
                    {module.title}
                  </CardTitle>
