      ...
      const naturverseQuests: Quest[] = [
        {
          ...
          description:
            'Complete 3 nature lessons with Turian the Durian and discover the secrets of tropical fruits!',
          completed: false,
          progress: 1,
          maxProgress: 3,
        ...
        },
        {
          ...
          description:
            'Explore 5 different beach zones with Coconut Cruze and learn about ocean ecosystems!',
          completed: false,
          progress: 2,
          maxProgress: 5,
        ...
        },
        {
          ...
          description:
            'Help Blue Butterfly pollinate 10 flowers and learn about the butterfly lifecycle!',
          completed: true,
          progress: 10,
          maxProgress: 10,
        ...
        },
        {
          ...
          description:
            'Study with Frankie Frogs to understand pond ecosystems and complete the amphibian quiz!',
          completed: false,
          progress: 0,
          maxProgress: 1,
        ...
        },
        {
          ...
          description:
            'Conduct 3 safe experiments with Dr P and earn your junior scientist certificate!',
          completed: false,
          progress: 0,
          maxProgress: 3,
        ...
        },
        {
          ...
          description:
            'Create beautiful music with Jay-Sing by recording 5 different nature sounds!',
          completed: false,
          progress: 1,
          maxProgress: 5,
        ...
        },
        {
          ...
          description:
            'Climb to the highest peak with Nikki MT and learn about mountain weather patterns!',
          completed: false,
          progress: 0,
          maxProgress: 1,
        ...
        },
        {
          ...
          description:
            'Learn sustainable farming with Pineapple Pa-Pa by growing your own virtual garden!',
          completed: false,
          progress: 3,
          maxProgress: 7,
          ...
          {quests.map((quest) => (
            ...
            >
              ...
              <CardContent className="p-6">
                ...
                <div className="mb-4">
                  <div
                    className="flex justify-between text-sm font-bold text-gray-700 mb-2"
                    style={{ fontFamily: 'Fredoka, sans-serif' }}
                  >
                    <span>Progress</span>
                    <span>
                ...
                <div className="text-center">
                  {quest.completed ? (
                    ...
                    <Button className="btn-magical text-sm px-4 py-2">Start Quest</Button>
                  )}
                </div>
              </CardContent>
            </Card>
